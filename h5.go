...
*/
func (*h5) HashTypeLength() uint { _ = "STUB: not implemented"; return 0 }
...
func hashBytesH5(data []byte, shift int) uint32 { _ = "STUB: not implemented"; return 0 }
...
func (h *h5) Initialize(params *encoderParams) { _ = "STUB: not implemented"; return }
...
*/
func (h *h5) Store(data []byte, mask uint, ix uint) { _ = "STUB: not implemented"; return }
...
func (h *h5) PrepareDistanceCache(distance_cache []int) { _ = "STUB: not implemented"; return }
